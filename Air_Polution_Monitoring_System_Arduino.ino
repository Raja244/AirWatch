...
// For LED
LiquidCrystal lcd(1,2,3,4,5,6); // RS, E, D4, D5, D6, D7
const int lcdContrast = 9;

// For Dust Sensor
int measurePin = 10;   // Connect dust sensor analog measure pin to Arduino A0 pin
int ledPin = 7;        // Connect dust sensor LED pin to Arduino pin 2
